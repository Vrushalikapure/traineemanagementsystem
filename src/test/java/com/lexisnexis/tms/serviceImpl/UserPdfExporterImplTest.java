...
class UserPdfExporterImplTest implements BaseTest {
    ...
    @Test
    public void verifyPdfContent(WorkHistory workHistory, User user) throws UserNotFoundException {
        ...
        assertEquals("User Name", pdfPTable.getRow(0).getCells()[0].getPhrase().getContent());
    ...
    @Test
    public void verifyPdfContentWhenAsyncIsTrue(WorkHistory workHistory, User user) throws UserNotFoundException, IOException {
    ...
    @Test
    public void interruptedExceptionFromCompletableFutureIsHandledSuccessfully(WorkHistory workHistory, User user) throws UserNotFoundException, ExecutionException, InterruptedException {
    ...
    @Test
    public void executionExceptionFromCompletableFutureIsHandledSuccessfully(WorkHistory workHistory, User user) throws UserNotFoundException, ExecutionException, InterruptedException {
